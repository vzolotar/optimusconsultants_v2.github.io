...
defined('_JEXEC') or die('Restricted access'); ?>
	<a class="search-switch" href="<?php echo JRoute::_("index.php?option=com_search");?>" onclick="this.blur();showBox('gl-search','mod_search_searchword',this);return false;">Search
	</a>
	<!--SEARCH content-->
			<div id="gl-search">
