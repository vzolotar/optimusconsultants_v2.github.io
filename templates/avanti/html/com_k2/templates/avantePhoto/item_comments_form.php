...
<h3 class="commentform"><?php echo JText::_('Add comment') ?></h3>

<form action="<?php echo JURI::root();?>index2.php" method="post" id="comment-form" class="form-validate">
	<label class="formComment" for="commentText"><?php echo JText::_( 'Comment' );?></label><br />
	...
	<label class="formUrl" for="commentURL"><?php echo JText::_('URL (optional)');?></label><br />
