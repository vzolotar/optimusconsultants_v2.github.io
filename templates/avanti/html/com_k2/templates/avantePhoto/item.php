...
<!-- Avanti K2 Left Column --> 
  <div class="avanteK2Left">
  	<div class="articleMetak2Avante">
...
<?php if($this->item->params->get('itemAuthor')): ?>
		...
		<p class="itemCategory">
			<span><strong><?php echo JText::_('Published in'); ?></strong></span>
	  ...
	  <div class="itemTagsBlock">
		  <span><strong><?php echo JText::_("Tagged under"); ?></strong></span>
		  <ul class="itemTags">
	...
	<div class="fontSize">
			<!-- Font Resizer -->
				...
				<span class="itemTextResizerTitle"><strong><?php echo JText::_('font size'); ?></strong></span>
				<div class="clear"></div>
	...
	<div class="itemRatingBlock">
		<span><strong><?php echo JText::_('Rate this item'); ?></strong></span> 
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<strong><?php echo JText::_("Related items"); ?></strong>
		<ul>
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest">
		<strong><?php echo JText::_("Latest from"); ?> <?php echo $this->item->author->name; ?></strong>
		<ul>
...
<!-- End Avante k2 Left Column -->
<!-- Start Avante right Column -->
  ...
  <div class="itemComments">
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
	    	  ...
	    	  <div class="avanteK2commentsLeft">
	...
	<div class="clear"></div>
		    ...
		    <span class="commentAuthorEmail">
	    	  ...
	    	  <div class="avanteK2commentsRight">
